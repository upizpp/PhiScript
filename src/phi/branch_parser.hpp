...
namespace phi {
    class BranchParser {
      ...
      public:
        ...
        explicit BranchParser(const string &name, const Branches &branches = {},
                              const SubBranches &sub_branches = {})
            : _M_name(name), _M_branches(branches),
              _M_sub_branches(sub_branches) {}
