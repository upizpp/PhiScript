...
namespace phi {
    namespace modules {
        ...
        class ModuleDB {
          ...
          public:
            void registerModule(const string &name,
                                const Ref<Object> &instance) {
                _M_modules[name] = instance;
            }
            void registerModule(const string &name, const Variant::Type &type,
                                const Ref<Object> &instance) {
            ...
            Ref<Object> get(const string &name) { return _M_modules[name]; }
        ...
        class TypeModuleRegister {
          public:
            TypeModuleRegister(const string &name, const Variant::Type &type,
                               const Ref<Object> &instance) {
                Singleton<ModuleDB>::instance()->registerModule(name, type,
                                                                instance);
            }
        };
    } // namespace modules
