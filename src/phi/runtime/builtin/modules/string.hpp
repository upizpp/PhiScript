...
#define MESSAGE_BODY                                                           \
    ...
    FIELD_METHOD(split, vector<string>, const string &self,                    \
                 const string &delimiter, Optional<bool>);                     \
    FIELD_METHOD(get_slice, string, const string &self,                        \
    ...
    FIELD_METHOD(ltrim, string, const string &self, OptionalRef<string> ws);   \
    FIELD_METHOD(rtrim, string, const string &self, OptionalRef<string> ws);   \
    FIELD_METHOD(trim, string, const string &self, OptionalRef<string> ws);    \
    FIELD_METHOD(absolute, string, const string &self, const string &result);
